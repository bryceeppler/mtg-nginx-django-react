...
# NOT COMPLETE
# Postponing since this is not a priority
# FacetoFace is expensive, paginated, and the
# cards can be on sale which complicates the scraping


class FaceToFaceScraper():
    def __init__(self, cardName):
        self.cardName = cardName
        self.results = []
        self.baseUrl = 'https://www.facetofacegames.com'
        self.searchUrl = self.baseUrl + '/search/?keyword='
    ...
    def scrape(self):
        ...
        cards = sp.select('div.hawk-results__item')
        print(cards)
        stockList = []
